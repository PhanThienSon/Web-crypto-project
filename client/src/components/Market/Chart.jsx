    ...
    return (
        <div className="w-full h-[80%]">
            ...
            <div className="flex">
                ...
                <button
                    className={`text-sm py-0.5 px-1.5 ml-2 bg-opacity-25 rounded capitalize ${days === 1 ? "bg-cyan text-cyan" : "bg-gray-200 text-gray-100"
                        }`}
                    onClick={() => setDays(1)}
                >
                    1d
                ...
                <button
                    className={`text-sm py-0.5 px-1.5 ml-2 bg-opacity-25 rounded capitalize ${days === 180 ? "bg-cyan text-cyan" : "bg-gray-200 text-gray-100"
                        }`}
                    onClick={() => setDays(180)}
                >
                    6m
                ...
                <button
                    className={`text-sm py-0.5 px-1.5 ml-2 bg-opacity-25 rounded capitalize ${days === 365 ? "bg-cyan text-cyan" : "bg-gray-200 text-gray-100"
                        }`}
                    onClick={() => setDays(365)}
                >
                    1y
