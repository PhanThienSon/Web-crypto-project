...
import submitIcon from "../Market/assets/submit-icon.svg";
import selectIcon from "../Market/assets/select-icon.svg";
    ...
    >
     ...
     "
        ...
        <label className="relative flex justify-center items-center">
          <span className="font-bold mr-2 text-cyan">Sort by: </span>
          <select
            name="sortby"
            className="text-cyan rounded bg-gray-200 text-base 
         ...
         "
          ...
          <img
            src={selectIcon}
            alt="submit"
            className="w-[1.6rem] h-auto absolute right-1 top-2 pointer-events-none
         "
          />
        </label>
        <button
