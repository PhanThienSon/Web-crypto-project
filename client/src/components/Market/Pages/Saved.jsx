import { Navbar, Footer, Navigation, TrendingCoin } from "../../index";
  ...
  return (
    ...
    >
      <svg
        ...
        height="30"
        viewBox="0 0 30 30"
        fill= {allCoins.includes(data.id)
          ? 'cyan'
          : 'gray'
          }
    ...
    <div className="gradient-bg-transactions">
      ...
      <div className="flex justify-center">
        ...
        {savedData && 
              ...
              <tbody>
                {savedData.map((coindata) => (
                  <tr
                    key={coindata.id}
                    className="text-center text-base text-white border-b border-gray-100 
               hover:bg-gray-200 last:border-b-0"
                  >
                    <td className="py-4 justify-center align-middle flex items-center uppercase">
                      <SaveBtn data={coindata} />
                      <img
                      ...
                      />
                      <span>
                        <Link to={`/${coindata.id}`} className="cursor-pointer">
                          {coindata.symbol}
                        </Link>
                      </span>
                    </td>
                    ...
                    <td className="py-4">${coindata.total_volume.toFixed(2)}</td>
  
  
                    <td className={coindata.market_cap_change_percentage_24h > 0 ? 'text-green py-4 lg:table-cell hidden"' : 'text-red py-4 lg:table-cell hidden"'}>
                      {Number(coindata.market_cap_change_percentage_24h).toFixed(2)}%</td>
  
  
                    <td className={coindata.price_change_percentage_1h_in_currency > 0 ? 'text-green py-4 lg:table-cell hidden"' : 'text-red py-4 lg:table-cell hidden"'}>
                      {Number(coindata.price_change_percentage_1h_in_currency).toFixed(2)}%</td>
  
  
                    <td className={coindata.price_change_percentage_24h_in_currency > 0 ? 'text-green py-4 lg:table-cell hidden"' : 'text-red py-4 lg:table-cell hidden"'}>
                      {Number(coindata.price_change_percentage_24h_in_currency).toFixed(2)}%</td>
  
  
                    <td className={coindata.price_change_percentage_7d_in_currency > 0 ? 'text-green py-4 lg:table-cell hidden"' : 'text-red py-4 lg:table-cell hidden"'}>
                      {Number(coindata.price_change_percentage_7d_in_currency).toFixed(2)}%</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        >
          ...
          >
            ...
            <path fill="cyan" d="M20.817 11.186a8.94 8.94 0 0 0-1.355-3.219 9.053 9.053 0 0 0-2.43-2.43 8.95 8.95 0 0 0-3.219-1.355 9.028 9.028 0 0 0-1.838-.18V2L8 5l3.975 3V6.002c.484-.002.968.044 1.435.14a6.961 6.961 0 0 1 2.502 1.053 7.005 7.005 0 0 1 1.892 1.892A6.967 6.967 0 0 1 19 13a7.032 7.032 0 0 1-.55 2.725 7.11 7.11 0 0 1-.644 1.188 7.2 7.2 0 0 1-.858 1.039 7.028 7.028 0 0 1-3.536 1.907 7.13 7.13 0 0 1-2.822 0 6.961 6.961 0 0 1-2.503-1.054 7.002 7.002 0 0 1-1.89-1.89A6.996 6.996 0 0 1 5 13H3a9.02 9.02 0 0 0 1.539 5.034 9.096 9.096 0 0 0 2.428 2.428A8.95 8.95 0 0 0 12 22a9.09 9.09 0 0 0 1.814-.183 9.014 9.014 0 0 0 3.218-1.355 8.886 8.886 0 0 0 1.331-1.099 9.228 9.228 0 0 0 1.1-1.332A8.952 8.952 0 0 0 21 13a9.09 9.09 0 0 0-.183-1.814z" />
