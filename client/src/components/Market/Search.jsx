...
import searchIcon from "../Market/assets/search-icon.svg";
...
const SearchInput = ({ handleSearch }) => {
    ...
    return (
      ...
      "
          ...
          placeholder:text-gray-100 pl-2 text-white
                ...
                >
                    {searchData ? (
                        searchData.map((coin) => {
                            return (
                                <li
                                    className="flex items-center ml-4 my-2 cursor-pointer text-white"
                                    key={coin.id}
