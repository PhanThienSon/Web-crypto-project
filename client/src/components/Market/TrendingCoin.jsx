...
const TrendingCoin = ({ data }) => {
  ...
  return (
    ...
    last:mb-0 rounded-lg p-5 relative cursor-pointer
    hover:bg-gray-100 hover:bg-opacity-40 mr-5"
        ...
        data ? (
          <>
            ...
            <img
              src={data.large}
              alt={data.name}
              className="w-[25%] h-auto rounded-full absolute top-2/4 -right-1 -translate-y-2/4"
            />
          </>
        ) : (
          <div
